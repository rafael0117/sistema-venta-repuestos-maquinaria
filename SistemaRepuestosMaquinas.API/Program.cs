...
builder.Services.Configure<CulqiOptions>(builder.Configuration.GetSection(CulqiOptions.SectionName));
...
builder.Services.AddHttpClient<ICulqiService, CulqiService>();
